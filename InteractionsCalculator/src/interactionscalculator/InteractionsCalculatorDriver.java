 ...
 * file, filtering for lines that begin with a digit and are length of 3. Each
 * line contains date, time, and number of interactions in that order. It sums
 * the interactions by hour by day and writes a CSV file with a header. Each
 * column is a day of week starting at Monday. Each row is an hour starting at
 * 000.
 *
 * @author JShepherd
 */
